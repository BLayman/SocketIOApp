...
var AppComponent = (function () {
    function AppComponent(userService, dialog) {
        ...
        this.dialog = dialog;
        this.title = 'Share Code'; // html title
        this.admin = false; // non-admin privaleges by default
        // user info
        this.userID = "";
        this.nickname = "";
...
var ProbSelectComponent = (function () {
    function ProbSelectComponent(probService, postService) {
        ...
        this.postService = postService;
        this.default = " -- select an option -- "; // default dropdown selection
        this.keyVal = {}; // library for accessing rooms using database ids
        this.probs = [this.default]; // list of problems bound to html
        this.justCreated = false; // for switching to newly made problem
    }
...
var SubmitPostComponent = (function () {
    function SubmitPostComponent(postService) {
        this.postService = postService;
        this.textBody = ""; // post text bound to html
    }
